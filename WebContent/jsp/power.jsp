...
<script type="text/javascript" src="../resource/js/power.js"></script>
</head>
<body>
	...
	<div id="dlg" class="easyui-dialog"
		...
		<form id="fm" method="post">
			<div class="fitem">
				<label>权限编号:</label> <input name="power_id" class="easyui-validatebox"
					required="true">
			</div>
			<div class="fitem">
				<label>权限：&nbsp;&nbsp;&nbsp;&nbsp;</label> <input name="power">
			</div>
